...
public:
     ...
     *  - \b Peripheral (Display string: 'Peripheral'): Controlable device (with no data stream handling).
...
public:
     ...
     *  - \b ExposureStart (Display string: 'Exposure Start'): Starts with the reception of the Exposure Start.
     *  - \b ExposureEnd (Display string: 'Exposure End'): Starts with the reception of the Exposure End.
     *  - \b Line0 (Display string: 'Line 0'): Starts when the specidfied TimerTriggerActivation condition is met on the chosen I/O Line.
     *  - \b Line1 (Display string: 'Line 1'): Starts when the specidfied TimerTriggerActivation condition is met on the chosen I/O Line.
     *  - \b Line2 (Display string: 'Line 2'): Starts when the specidfied TimerTriggerActivation condition is met on the chosen I/O Line.
     *  - \b Line#3# (Display string: 'Line #3#'): Starts when the specidfied TimerTriggerActivation condition is met on the chosen I/O Line.
     *  - \b UserOutput0 (Display string: 'User Output 0'): Specifies which User Output bit signal to use as internal source for the trigger.
     *  - \b UserOutput1 (Display string: 'User Output 1'): Specifies which User Output bit signal to use as internal source for the trigger.
     *  - \b UserOutput2 (Display string: 'User Output 2'): Specifies which User Output bit signal to use as internal source for the trigger.
     *  - \b UserOutput#3# (Display string: 'User Output #3#'): Specifies which User Output bit signal to use as internal source for the trigger.
     ...
     *  - \b Line3 (Display string: 'Line 3'): Starts when the specidfied TimerTriggerActivation condition is met on the chosen I/O Line.
     *  - \b Line4 (Display string: 'Line 4'): Starts when the specidfied TimerTriggerActivation condition is met on the chosen I/O Line.
     *  - \b Line5 (Display string: 'Line 5'): Starts when the specidfied TimerTriggerActivation condition is met on the chosen I/O Line.
     *  - \b Line6 (Display string: 'Line 6'): Starts when the specidfied TimerTriggerActivation condition is met on the chosen I/O Line.
     *  - \b Line7 (Display string: 'Line 7'): Starts when the specidfied TimerTriggerActivation condition is met on the chosen I/O Line.
     *  - \b Line8 (Display string: 'Line 8'): Starts when the specidfied TimerTriggerActivation condition is met on the chosen I/O Line.
     *  - \b Line9 (Display string: 'Line 9'): Starts when the specidfied TimerTriggerActivation condition is met on the chosen I/O Line.
     *  - \b Line10 (Display string: 'Line 10'): Starts when the specidfied TimerTriggerActivation condition is met on the chosen I/O Line.
     *  - \b Line11 (Display string: 'Line 11'): Starts when the specidfied TimerTriggerActivation condition is met on the chosen I/O Line.
     *  - \b Line12 (Display string: 'Line 12'): Starts when the specidfied TimerTriggerActivation condition is met on the chosen I/O Line.
     *  - \b Line13 (Display string: 'Line 13'): Starts when the specidfied TimerTriggerActivation condition is met on the chosen I/O Line.
     *  - \b Line14 (Display string: 'Line 14'): Starts when the specidfied TimerTriggerActivation condition is met on the chosen I/O Line.
     *  - \b Line15 (Display string: 'Line 15'): Starts when the specidfied TimerTriggerActivation condition is met on the chosen I/O Line.
     *  - \b UserOutput3 (Display string: 'User Output 3'): Specifies which User Output bit signal to use as internal source for the trigger.
     *  - \b UserOutput4 (Display string: 'User Output 4'): Specifies which User Output bit signal to use as internal source for the trigger.
     *  - \b UserOutput5 (Display string: 'User Output 5'): Specifies which User Output bit signal to use as internal source for the trigger.
     *  - \b UserOutput6 (Display string: 'User Output 6'): Specifies which User Output bit signal to use as internal source for the trigger.
...
public:
    ...
    /// \brief An integer property. Sets the the minimum iris signal level in mV.
    /**
     *  Sets the the minimum iris signal level in mV.
     */
    PropertyI64 mvIrisSignalLevelMin;
    /// \brief An integer property. Sets the the maximum iris signal level in mV.
    /**
